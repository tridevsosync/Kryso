...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Music lessons and instruments in Pune, Maharashtra." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Kryso Music Academy" },
      { property: "og:description", content: "Learn music and enjoy music in Pune." },
